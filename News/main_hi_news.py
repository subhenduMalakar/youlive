...
if(d.entries[i1].title!=new1):
    ...
    if new1 in text2:
        ...
        arguments = {"keywords":dirC,"limit":3,"print_urls":True,"format":"jpg","usage_rights":"labeled-for-reuse"}   #creating list of arguments
        paths = response.download(arguments)   #passing the arguments to the function
        print(paths)
        from googletrans import Translator
        translator = Translator()
        a=translator.translate(summery, dest='hi')

        summery=a.text
        tts = gTTS(a.text, lang='hi')
        tts.save(dirC+'.mp3')
        sendsum=summery
        ...
        print("-------------------------------------- 2")
        b1='ffmpeg -i downloads/'+dirC+'/slideshow.mp4 -i '+dirC+'.mp3 -c copy -map 0:0 -map 1:0 downloads/'+dirC+'/out.mp4'
